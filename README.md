# <img src="./images/icon.ico" alt="Zound logo" width="60"/> Zound
...
> [!CAUTION]
> *To developers*: Zound requires [Python 3.12](https://www.python.org/downloads/). Compatibility with earlier versions is not guaranteed!
